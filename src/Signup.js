    ...
    return (
        ...
        <View style={{alignItems:"center", 
           ...
           <Text style={{
            ...
            <Text style={{color:"white",fontSize:16,fontWeight:"bold",marginBottom:20}}>Create a new Account</Text>
           <View style={{
            ...
            <View
             style={{ display:"flex",flexDirection:"row",width: '78%', paddingRight: 16}}> 
            ...
            <Btn textColor='white' bgColor={darkGreen} btnLabel="Signup" Press={() => {alert
            ("Account Created")
            ...
            <View style= {{display:'flex',flexDirection: 'row', justifyContent:
             'center'}}>
                ...
                <Text style={{color: darkGreen, fontWeight:'bold',fontSize:16}}> Login 
             </Text>
             </TouchableOpacity>
            </View>
           </View>
